...
{	
	...
	public class ModelResourcesDesc
	{
		...
		{			
            ...
            typeIdsInInsertOrder.Add(ModelCode.IRREGULARTP);
			typeIdsInInsertOrder.Add(ModelCode.CURVE);			
			typeIdsInInsertOrder.Add(ModelCode.CURVEDATA);
            typeIdsInInsertOrder.Add(ModelCode.REGULARINTERVALSCH);
		...
		{			
			...
			notSettablePropertyIds.Add(ModelCode.IRREGULARINTERVALSCH_TIMEPOINTS);
			notSettablePropertyIds.Add(ModelCode.REGULARINTERVALSCH_TIMEPOINTS);
            notSettablePropertyIds.Add(ModelCode.PSR_OUTAGESCHS);	
		}
