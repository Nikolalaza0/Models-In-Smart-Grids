...
namespace FTN.Common
{
	public class EnumDescs
	{
		...
		public EnumDescs()
		{
            ...
            //BasicIntSch
            property2enumType.Add(ModelCode.BASICINTERVALSCH_VALUE1MULTI, typeof(UnitMultiplier));
            property2enumType.Add(ModelCode.BASICINTERVALSCH_VALUE1UNIT, typeof(UnitSymbol));

            property2enumType.Add(ModelCode.BASICINTERVALSCH_VALUE2MULTI, typeof(UnitMultiplier));
